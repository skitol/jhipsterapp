...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'findsar';
    ...
    'jhipster.mail.from' = 'findsar@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'findsar API';
    'jhipster.swagger.description' = 'findsar API documentation';
    ...
    'eureka.instance.appname' = 'findsar';
    'eureka.instance.instanceId' = 'findsar:${random.value}';
